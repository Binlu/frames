...
(function () { 
    ...
    */
    TextIconOverlay.prototype._buildCssText = function(style) {    
        ...
        /*--------lut000 edit in 2018/03/26 增加特定的样式--------*/
        var more_sty='width: 80px;height:80px;background-color: rgba(222,125,10,1);color:#fff;border-radius: 50%;';

        csstext.push(more_sty+'cursor:pointer; color:' + textColor + '; position:absolute; font-size:' +
