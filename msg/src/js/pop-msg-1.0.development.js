...
!function(g){
	function atten(){
		...
		this.v_list={							//相关属性
			...
			is_delay:false,
			times:800,
			_html:'<!-- 弹出提示 --><div id="msg-box" style="display: none;z-index: 9999;position: fixed;left: 30%;top:20%;width: 600px;padding: 30px 0;margin: auto;border-radius: 5px;text-align: center;background-color: #fff;"><p class="atten-p">网络似乎出现了问题，请稍后再试。</p><div class="btn-div" style="margin-top: 30px;"><a class="js-sure" href="javascript:void(0);" title="" style="margin-right:15px;display: inline-block;*display: inline-block;padding: 5px 15px;border-radius: 2px;text-decoration: none;color: #fff;background-color: #1195EE">确定</a><a class="js-cancel" href="javascript:void(0);" title="" style="display: inline-block;*display: inline-block;padding: 5px 15px;border-radius: 2px;text-decoration: none;color: #fff;background-color: #1195EE">取消</a></div></div><div id="msg-bg" style="display: none;z-index: 9998;position: fixed;left: 0px;top: 0;width: 100%;height:100%;opacity: 0.7;filter:alpha(opacity=70);background-color: #000;"></div>'
		}
	};
	atten.prototype={
		init:function(){				//初始化参数
